...
<body>
    ...
    <div class="content">
        <form class="form" action="<?php echo e(route('salary.store')); ?>" method="POST">
            ...
            <p class="input-label">Net pay:</p>
            <input type="number" class="input" name="net_pay" placeholder="Enter net pay" required>
...
</html><?php /**PATH C:\Users\ACER\Documents\Project\Employee-Management-Web\resources\views/salary/create.blade.php ENDPATH**/ ?>